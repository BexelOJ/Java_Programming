public class Java_20260821_AF_ChicagoPizzaIngredientFactory implements Java_20260821_AF_PizzaIngredientFactory {

    @Override
    public Java_20260821_AF_Dough createDough() {
        return new Java_20260821_AF_ThickCrustDough();
    }

    @Override
    public Java_20260821_AF_Sauce createSauce() {
        return new Java_20260821_AF_PlumTomatoSauce();
    }

    @Override
    public Java_20260821_AF_Cheese createCheese() {
        return new Java_20260821_AF_MozzarellaCheese();
    }
    ...
    public Java_20260821_AF_Clams createClam() {
        return new Java_20260821_AF_FrozenClams();
    }
}
